...
<template>
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action = "http://localhost:4000/items/displayMenuItems" method="post">
                <div class="form-group has-feedback">
                    <input type="text" name="logemail" placeholder="Username" class="form-control" id="login">
            ...
            <br>
            <router-link class="btn btn-danger" :to="{name: 'Home'}"><= Go to Home page</router-link>
        </div><!-- /.login-box-body -->
    </div>
</template>